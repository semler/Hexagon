...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if([userDefaults boolForKey:@"dungeon_two"] == YES){
        ...
        [self.dungeonTwoButton setImage:[UIImage imageNamed:@"button2.png"] forState:UIControlStateNormal];
    ...
    if([userDefaults boolForKey:@"dungeon_x"] == YES){
        [self.dungeonTwoButton setImage:[UIImage imageNamed:@"button1.png"] forState:UIControlStateNormal];
